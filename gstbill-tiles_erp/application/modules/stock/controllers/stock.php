...
//	exit;
    ...
    function export_csv($query, $timezones = array()) {
        ...
        fputcsv($output, array('Category', 'Product Name', 'Brand', 'System Quantity', 'Physical Quantity'));
        ...
        foreach ($query as $val) {
            ...
            $row = array($val['categoryName'], $val['product_name'], $val['brands'], round($val['quantity']), '');
...
//	exit;
    ...
    function export_csv_stock_based_report($query, $timezones = array()) {
        ...
        foreach ($query as $val) {
            ...
            $quantity = number_format($val['quantity']);
