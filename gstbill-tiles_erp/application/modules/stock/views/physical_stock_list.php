    ...
    <div class="contentpanel mb-50">
        <div id='result_div' class="panel-body stock_table">
            <table id="basicTable" class="display dataTable table table-striped table-bordered responsive dtr-inline no-footer date-cntr doc-cntr val-cntr rate-right" cellspacing="0" width="100%">
                <thead>
                    <tr>                        <th width='5%' class="action-btn-align">S.No</th>                        <th width='10%'class="action-btn-align">Entry Date</th>                        <th width='5%'class="action-btn-align">Entry Document</th>                        <th width='10%'class="action-btn-align">Shrinkage value</th>                        <th width='10%'class="action-btn-align">Shrinkage Rate</th>                        <th width='10%' class="action-btn-align">Action</th>                    </tr>
                </thead>
                <tbody id='result_div'>
                    <?php
