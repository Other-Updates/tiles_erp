            ...
            <table id="example1" class="display dataTable table table-striped table-bordered responsive dataTable dtr-inline no-footer
                ...
                <thead>
                    <tr>
                        ...
                        <th width='20%' class="action-btn-align">Section</th>
                        <th width='15%' class="action-btn-align">Category</th>
                        <th width='5%' class="action-btn-align">Brand</th>
                        <th width='15%' class="action-btn-align">Product Name</th>
                        <th width='10%'class="action-btn-align">Cost Price</th>
                        <th width='5%' class="action-btn-align">Quantity</th>
                        <th width='5%' class="action-btn-align">Total Price (Without GST)</th>
                        <th width='5%' class="action-btn-align">CGST Amt</th>
                        <th width='5%' class="action-btn-align">SGST Amt</th>
                        <th width='5%' class="action-btn-align">Total Price (With GST)</th>
