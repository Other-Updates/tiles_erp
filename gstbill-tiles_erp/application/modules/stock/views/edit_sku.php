                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="hidden" id="id" value="<?php echo $sku[0]['id']; ?>">
...
<?php if (count($firms) > 1) { ?>
    ...
    if (isset($firms) && !empty($firms)) {
        ...
        foreach ($firms as $firm) {
            ...
            $select = ($sku[0]['firm_id'] == $firm['firm_id']) ? 'selected' : '';
            ?>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text"  tabindex="1" name="sku[sku_no]" class="code form-control colournamedup  form-align" readonly="readonly" value="<?php echo $sku[0]['sku_no']; ?>"  id="grn_no">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" tabindex="1"  class="form-align datepicker required" name="sku[sku_date]" value="<?php echo date('d-m-Y', strtotime($sku[0]['sku_date'])); ?>" placeholder="dd-mm-yyyy" >
...
<?php
if (isset($sku_details) && !empty($sku_details)) {



    foreach ($sku_details as $det) {
        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select id='cat_id' class='cat_id static_style class_req required form-control form-align' name='categoty[]' style="width:100%" disabled="disabled">
        ...
        if (isset($category) && !empty($category)) {
            ...
            foreach ($category as $val) {
                ...
                $select = ($det['cat_id'] == $val['cat_id']) ? 'selected' : '';
                ?>
                                ...
                                ?>
                                    ...
                                    <td class="relative">
                                        ...
                                        <input type="text"  name="model_no[]" id="model_no" style="width:100%" value="<?php echo $det['product_name']; ?>" class='form-align auto_customer tabwid model_no required form-control' tabindex="1" readonly="" />

                                        <span class="error_msg"></span>

                                        <input type="hidden"  name="product_id[]" id="product_id" value="<?php echo $det['product_id']; ?>" class='product_id tabwid form-align' />
                                        ...
                                        <select id='brand_id' name='brand[]' tabindex="1" class="form-control form-align brand_id">
                                            ...
                                            if (isset($brand) && !empty($brand)) {
                                                ...
                                                foreach ($brand as $val) {
                                                    ...
                                                    $select = ($det['brand_id'] == $val['id']) ? 'selected' : '';
                                                    ?>

                                                    <option value='<?php echo $val['id'] ?>' <?php echo $select; ?>><?php echo $val['brands'] ?></option>
        ...
        ?>
                                    ...
                                    <td>
                                        ...
                                        <select id='b_id' name='sku_type[]' tabindex="1" class="form-control form-align">
                                            ...
                                            <option value="1" <?php echo ($det['sku_type'] == 'Return') ? 'Selected' : ''; ?>>Remove</option>

                                            <option value="2" <?php echo ($det['sku_type'] == 'Request') ? 'Selected' : ''; ?>>Add</option>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" id="stock"   tabindex="1"  name='stock[]' value="<?php echo $det['stock']; ?>" style="width:70px;" class="stock required form-control form-align" readonly="" />
                                    ...
                                    <td>
                                        ...
                                        <input type="text"   tabindex="1" id="qty"  name='quantity[]' value="<?php echo $det['qty']; ?>" style="width:70px;" class="qty percost required form-control form-align" />
...
<script type="text/javascript">
    ...
    $('#add_group').click(function () {
        ...
        $(tableBody).closest('tr').find('select,.model_no,.model_no_ser,.stock,.qty').addClass('required');
