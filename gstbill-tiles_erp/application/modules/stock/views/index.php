...
<div class="mainpanel">
    ...
    <div class="contentpanel">
        ...
        <div id='result_div' class="panel-body">
            ...
            <table id="basicTable" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline quatation-cntr date-cntr">
