                        ...
                        <form  method="POST"  name="upform" enctype="multipart/form-data" action="<?php echo $this->config->item('base_url') . 'customer/update_customer'; ?>"> 
                            <table  class="table table-striped  responsive no-footer dtr-inline">
                                ...
                                if (isset($customer) && !empty($customer)) {
                                   ...
                                   <td>
                                        <div class="input-group">
                                            <input type="text"  name="credit_days"  class="form-control form-align" id="credit_days" value="<?= $val['credit_days'] ?>"/>
                                            <div class="input-group-addon">
                                                <i class="fa fa-fw fa-money"></i>
                                            </div>
                                        </div>
                                   ...
                                   <td>
                                        <div class="input-group">
                                            <input type="text"  name="credit_limit"  class="form-control form-align" id="credit_limit" value="<?php if($val['credit_limit'] != '') { echo $val['credit_limit']; }else{ echo ''; } ?>"/>
                                            <div class="input-group-addon">
                                                <i class="fa fa-fw fa-money"></i>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <select name="customer_rigion" id="customer_type" class="customer_type form-control form-align">
                                            <option value="">Select Type</option>
                                            <option value="local" <?php if($val['customer_region'] == 'local'){ echo 'selected=selected'; }else { echo ''; }?>>Local Customers</option>
                                            <option value="non-local" <?php if($val['customer_region'] == 'non-local'){ echo 'selected=selected'; }else { echo ''; }?>>Non-Local Customers</option>
                                    ...
                                    <td>DOB</td>
                                   <td>
                                    <input type="text" name="dob"  class="datepicker" id="dob" value="<?php echo $val['dob']?>"/>
                                    <span id="dob1" class="val"  style="color:#F00; font-style:oblique;"></span>
                                   </td> 
                                    <td>Anniversary Date</td>
                                   <td>
                                            <input type="text"  name="anniversary"  class="datepicker" id="anniversary" value="<?php echo $val['anniversary']?>"/>
