...
<div class="mainpanel">
    ...
    <div class="contentpanel">
        ...
        <div class="panel-body  mb-25">
            <div class="tabs">
                ...
                <ul class="list-inline tabs-nav tabsize-17" role="tablist">
                    ...
                    <li role="presentation" class=""><a href="#customer" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false">Add Customer</a></li>
                </ul>
                <!-- Tab panes -->
                               ...
                               <!-- <tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   ...
                                   <td>
                                        <div class="input-group">
                                            <input type="text"  name="credit_days"  class="form-control form-align" id="credit_days" />
                                            <div class="input-group-addon">
                                                <i class="fa fa-fw fa-money"></i>
                                            </div>
                                        </div>
                                   ...
                                   <td>
                                        <div class="input-group">
                                            <input type="text"  name="credit_limit"  class="form-control form-align" id="credit_limit" />
                                            <div class="input-group-addon">
                                                <i class="fa fa-fw fa-money"></i>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                   ...
                                   <td>
                                            <input type="text"  name="anniversary"  class="datepicker" id="anniversary" />
        ...
        jQuery('.datepicker').datepicker();
            ...
            $('#credit_days').live('blur', function ()
            {
            ...
            $('#credit_limit').live('blur', function ()
            {
            ...
            $('#customer_region').live('blur', function ()
            {
            ...
            $('#anniversary').live('blur', function ()
            {
