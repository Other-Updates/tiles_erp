...
class Vendor extends MX_Controller {
	...
	public function update_vendor()
	{
		...
		/*'selling_percent'=>$this->input->post('percentage'),*/ 'state_id'=>$this->input->post('state_id'),'payment_terms'=>$this->input->post('payment_terms'),'tin'=>$this->input->post('tin'),'ifsc'=>$this->input->post('ifsc'));
