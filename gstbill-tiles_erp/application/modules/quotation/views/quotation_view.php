            ...
            foreach ($quotation as $val) {
                    ...
                    <table class="table table-striped table-bordered responsive" id="add_quotation" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr><td width="2%" class="first_td1 action-btn-align ser-wid">S.No</td>
                                ...
                                <td  width="10%" class="first_td1 action-btn-align ser-wid text_right">Unit&nbsp;Price</td>
                                <!--<td  width="5%" class="first_td1 action-btn-align ser-wid">Total</td>-->
                                <td  width="7%" class="first_td1 action-btn-align proimg-wid">Dis&nbsp;%</td>
                                ...
                                <?php } ?>
                                <td  width="7%" class="first_td1 text-right qty-wid">Net Value</td>
                            </tr>
                        </thead>
                        <tbody id='app_table'>
                            <?php
                ...
                <!--                                        <td class="text_right">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="3" class="hide_class" style="width:70px; text-align:right;"></td>
                                <td colspan="8" style="text-align:right;"><strong><?php echo $val['tax_label']; ?></strong> </td>
                                <td class="text_right">
                            ...
                            <tr>
                                <td colspan="3" class="hide_class" style="width:70px; text-align:right;"></td>
                                <td colspan="8" style="text-align:right;"><b>Taxable Price</b></td>
                                <td style="text-align:right;"><?php echo $val['taxable_price'] ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="hide_class" style="width:70px; text-align:right;"></td>
                                <td colspan="8" style="text-align:right;"><b>CGST</b></td>
                                <td style="text-align:right;"><?php echo $val['cgst_price'] ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="hide_class" style="width:70px; text-align:right;"></td>
                                <?php if($val['cus_state_id'] == 31) {?>
                                    <td colspan="8" style="text-align:right;"><b>SGST</b></td>
                                    <td style="text-align:right;"><?php echo $val['sgst_price'] ?></td>
                                <?php } else {?> 
                                    <td colspan="8" style="text-align:right;"><b>IGST</b></td>
                                    <td style="text-align:right;"><?php echo $val['igst_price'] ?></td>
                                <?php } ?>
                            </tr>
                            <tr>
                                <td colspan="3" class="hide_class" style="width:70px; text-align:right;"></td>
                                <td colspan="8" style="text-align:right; font-size:15px;"><strong>Net Total</strong></td>
                                <td class="text_right" style="font-size:15px;"><?php echo number_format($val['net_total'], 2); ?></td>
