...
<style>
    ...
    #ui-datepicker-div {
        z-index: 4 !important;
    }	table tr td:nth-child(5) {		text-align:center;	}	table tr th {		text-align:center;	}
</style>
<?php
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo $this->config->item('base_url'); ?>masters/customers/import_customers" enctype="multipart/form-data" name="import_customers" method="post" id="import_customers">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="customer_data" id="brand_data" class="form-control" accept=".csv,.xls,.xlsx">
