                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select  onchange="Firm(this.value)" name="firm_id"  class="form-control form-align" id="firm" tabindex="1">
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="category_id"  class="form-control form-align" id="category" tabindex="1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" name="product_name" class=" form-align" id="name" maxlength="70" value="<?php echo $val['product_name']; ?>" tabindex="1"/>
                                                        <div class="input-group-addon">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="brand_id"  class="form-control form-align" id="brand" tabindex="1">
                                                        <option value="">Select</option>
                                                        <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type='file' name="admin_image" class="imgInp form-control margin0" autocomplete="off"/><span id="profileerror9" class="val" style="color:#F00;" id="img" tabindex="1"></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" name="unit" class="form-align" id="unit" value="<?php echo $val['unit']; ?>" tabindex="1"/>
                                                        <div class="input-group-addon">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" name="cost_price" class=" form-align" id="cost_price" value="<?php echo $val['cost_price']; ?>" tabindex="1"/>
                                                        <div class="input-group-addon">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" name="barcode" class=" form-align" id="barcode" value="<?php echo $val['barcode']; ?>" tabindex="1"/>
                                                        <div class="input-group-addon">
