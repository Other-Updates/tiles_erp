...
<style>
    ...
    .dataTables_wrapper {position: relative;clear: both;zoom: 1;}		table tr th {		text-align:center;	}	table tr td:nth-child(5) {		text-align:center;	}
</style>
<div class="mainpanel">
    <div class="media">
        ...
        <div class="panel-body">
            <div class="tabs">
                ...
                <ul class="list-inline tabs-nav tabsize-17" role="tablist">
                    ...
                    <li role="presentation" class=""><a href="<?php if ($this->user_auth->is_action_allowed('masters', 'firms', 'add')): ?>#field-agent<?php endif ?>" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false" class="<?php if (!$this->user_auth->is_action_allowed('masters', 'firms', 'add')): ?>alerts<?php endif ?>">Add Firm</a></li>
                </ul>
                            ...
                            <table id="basicTable"  class="display dataTable table table-striped table-bordered responsive dataTable dtr-inline no-footer">
                                <thead>
                                    <tr>
                                        ...
                                        <th width='30%'>Firm/Company Name</th>
                                        ...
                                        foreach ($firms as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-btn-align">
                                                    <a href="<?php if ($this->user_auth->is_action_allowed('masters', 'firms', 'edit')): ?><?php echo $this->config->item('base_url') . 'masters/firms/edit_firm/' . $val['firm_id'] ?><?php endif ?>" class="btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'firms', 'edit')): ?>alerts<?php endif ?>" title="Edit">
                                                        <span class="fa fa-edit"></span></a>&nbsp;&nbsp;<a href="<?php if ($this->user_auth->is_action_allowed('masters', 'firms', 'delete')): ?>#test3_<?php echo $val['firm_id']; ?><?php endif ?>" data-toggle="modal" name="delete" class="btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'firms', 'delete')): ?>alerts<?php endif ?>" title="In-Active">
