...
<style type="text/css">
    .select2-container { border:0px #fff solid; }	table tr td:nth-child(4) {		text-align:center;	}	table tr th {		text-align:center;	}
</style>
<div class="mainpanel">
    <div class="media">
    </div>
                                        ...
                                        foreach ($agent as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-btn-align">
                                                    <a href="<?php if ($this->user_auth->is_action_allowed('masters', 'users', 'edit')): ?><?php echo $this->config->item('base_url') . 'masters/users/edit_user/' . $val['id']; ?><?php endif ?>" class="btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'users', 'edit')): ?>alerts<?php endif ?>" title="Edit">
                                                        <span class="fa fa-edit"></span></a>&nbsp;&nbsp;<a href="<?php if ($this->user_auth->is_action_allowed('masters', 'users', 'delete')): ?>#test3_<?php echo $val['id']; ?><?php endif ?>" data-toggle="modal" name="delete" class="btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'users', 'delete')): ?>alerts<?php endif ?>" title="In-Active">
