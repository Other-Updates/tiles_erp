...
<style>
    .input-group-addon .fa { width:10px !important; }	table tr td:nth-child(6) {		text-align:center;	}	table tr th {		text-align:center;	}
</style>
<div class="mainpanel">
    <div class="media">
                                        ...
                                        foreach ($references as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-btn-align">
                                                    <a href="<?php echo $this->config->item('base_url') . 'masters/reference_groups/edit_ref_group/' . $val['id']; ?>" class="tooltips btn btn-default btn-xs" title="Edit"><span class="fa fa-edit"></span></a>&nbsp;&nbsp;<a href="#test3_<?php echo $val['id']; ?>" data-toggle="modal" name="delete" class="tooltips btn btn-default btn-xs" title="In-Active"><span class="fa fa-ban"></span></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
