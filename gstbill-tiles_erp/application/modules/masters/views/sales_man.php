...
<style>
    .input-group-addon .fa { width:10px !important; }	table tr th {		text-align:center;	}	table tr td:nth-child(5) {		text-align:center;	}
</style>
<div class="mainpanel">
    <div class="media">
                    ...
                    <div role="tabpanel" class="tab-pane active tablelist" id="sales_man_list">
                        <div class="frameset_big1">
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive dataTable no-footer dtr-inline target-cntr" id="list">
                                ...
                                <th width='10%'>Sales Man Name</th>
                                <th width='15%'>Email Id</th>
                                <th width='10%'>Mobile Number</th>
                                <th width='10%'>Target Rate</th>
                                        ...
                                        foreach ($sales_man as $val) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="action-btn-align">
                                                    <a href="<?php echo $this->config->item('base_url') . 'masters/sales_man/edit_sales_man/' . $val['id']; ?>" class="btn btn-default btn-xs" title="Edit"><span class="fa fa-edit"></span></a>&nbsp;&nbsp;<a href="#test3_<?php echo $val['id']; ?>" data-toggle="modal" name="delete" class="btn btn-default btn-xs" title="In-Active"><span class="fa fa-ban"></span></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
...
<script type="text/javascript">
    ...
    {
        $("#sales_man_name").live('blur', function ()
        {
