                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" name="pin" class=" form-align" id="pincode" value="<?php echo $val['pincode']; ?>" tabindex="1"/>
                                                        <div class="input-group-addon">
                                                            <i class="fa fa-map-marker"></i>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" class=" form-align" name="payment" id="payment" value="<?php echo $val['payment_percent']; ?>"/>
                                                        <div class="input-group-addon">
