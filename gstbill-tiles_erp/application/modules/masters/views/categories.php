                                            ...
                                            foreach ($detail as $billto) {
                                                ...
                                                <tr><td class="first_td"><?php echo "$i"; ?></td>
                                                    ...
                                                    <td class="action-btn-align">
                                                        <a id="<?php $billto['cat_id']; ?>" href="<?php if ($this->user_auth->is_action_allowed('masters', 'categories', 'edit')): ?><?= $this->config->item('base_url') . 'masters/categories/update_categories/' . $billto['cat_id'] ?><?php endif ?>" class="btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'categories', 'edit')): ?>alerts<?php endif ?>" title="Edit">
                                                            <span class="fa fa-edit"></span></a>&nbsp;&nbsp;<a href="<?php if ($this->user_auth->is_action_allowed('masters', 'categories', 'delete')): ?>#test3_<?php echo $billto['cat_id']; ?><?php endif ?>" name="delete" class=" btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'categories', 'delete')): ?>alerts<?php endif ?>" title="In-Active">
                                ...
                                foreach ($detail as $billto) {
                                    ...
                                    <div id="test3_<?php echo $billto['cat_id']; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" align="center">
                                        <div class="modal-dialog"><div class="modal-content modalcontent-top"><div class="modal-header modal-padding modalcolor"><a class="close modal-close closecolor" data-dismiss="modal">×</a>
                                                    <h4 class="inactivepop">In-Active Category</h4><h3 id="myModalLabel"></h3>
