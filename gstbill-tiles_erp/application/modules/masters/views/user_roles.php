                                            ...
                                            <div class="form-group margin0">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input type="text" name="user_role[user_role]" id="user_role" class="borderra0 form-align" placeholder="Enter User Role" maxlength="30" />
                                        ...
                                        foreach ($user_roles as $list) {
                                            ...
                                            <tr><td class="first_td"><?php echo $i; ?></td>
                                                ...
                                                <td class="action-btn-align">
                                                    <a href="<?php if ($this->user_auth->is_action_allowed('masters', 'user_roles', 'edit')): ?><?php echo base_url() . 'masters/user_roles/user_permissions/' . $list['id']; ?><?php endif ?>" class="btn btn-default btn-xs <?php if (!$this->user_auth->is_action_allowed('masters', 'user_roles', 'edit')): ?>alerts<?php endif ?>" title="User Permissions"><span class="fa fa-gear"></span></a>&nbsp;
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
