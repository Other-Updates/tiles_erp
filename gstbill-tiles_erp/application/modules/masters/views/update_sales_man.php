            ...
            <div class="tabs">
                ...
                <div class="tab-content tabbor">
                    <div role="tabpanel" class="tab-pane active" id="update-sales-man">
                        ...
                        <form  method="POST"  name="upform" enctype="multipart/form-data" action="<?php echo $this->config->item('base_url') . 'masters/sales_man/update_sales_man'; ?>">
                                ...
                                if (isset($sales_man) && !empty($sales_man)) {
                                    ...
                                    foreach ($sales_man as $val) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" name="target_rate" class="store form-control form-align" id="store" value="<?php echo $val['target_rate'] ?>"/>
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-bank"></i>
                                                    </div>
                                                </div>
