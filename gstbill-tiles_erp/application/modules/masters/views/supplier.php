                        ...
                        <form action="<?php echo $this->config->item('base_url'); ?>masters/suppliers/insert_vendor" enctype="multipart/form-data" name="form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Email Address <span style="color:#F00; font-style:oblique;">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="text" name="mail" class="mail  form-align" id="mail" />
                                                <div class="input-group-addon">
                            ...
                            <table id="example" class="display dataTable table table-striped table-bordered responsive dataTable dtr-inline no-footer aln-cntr" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="12%">City</th>
                                        <th width="10%" class="action-btn-align"><div class="">Action</div></th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <div id="myModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo $this->config->item('base_url'); ?>masters/suppliers/import_suppliers" enctype="multipart/form-data" name="import_customers" method="post" id="import_customers">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="supplier_data" id="brand_data" class="form-control" accept=".csv,.xls,.xlsx">
