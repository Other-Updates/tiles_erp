    ...
    <div class="contentpanel">
        <div class="panel-body">
            <div class="tabs">
                <div class="">
                    <div id="update-field">
                        <form action="<?php echo $this->config->item('base_url') . 'masters/firms/update_firm/' . $firms[0]['firm_id']; ?>" enctype="multipart/form-data" name="form" method="post">
                            <?php
...
<script type="text/javascript">
    ...
    $("#prefix").live('blur', function ()
    {
        ...
        {
            $("#prefix_err").html("Required Field");
        } else
        {
            $("#prefix_err").html("");
        }
