...
class Suppliers extends MX_Controller {
    ...
    public function update_vendor() {
        ...
        $input = array('name' => $this->input->post('name'), 'store_name' => $this->input->post('store'), 'address1' => $this->input->post('address1'),
            ...
            'pincode' => $this->input->post('pin'), 'mobil_number' => $this->input->post('number'), 'email_id' => $this->input->post('mail'), 'dob' => $this->input->post('dob'),
            'anniversary_date' => $this->input->post('anniversary'), 'bank_name' => $this->input->POST('bank'), 'bank_branch' => $this->input->POST('branch'), 'account_num' => $this->input->POST('acnum'), 'firm_id' => $this->input->POST('firm_id'), 'firm_id' => $this->input->POST('firm_id'), 'created_by' => $this->user_auth->get_user_id(), 'payment_percent' => $this->input->post('payment'),
            'credit_days' => $this->input->post('credit_days'), 'state_id' => $this->input->post('state_id'), 'payment_terms' => $this->input->post('payment_terms'), 'tin' => $this->input->post('tin'), 'ifsc' => $this->input->post('ifsc'), 'landline' => $this->input->post('landline'));
